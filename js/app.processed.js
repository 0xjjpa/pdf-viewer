...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _inputfile = __webpack_require__(298);

	var _inputfile2 = _interopRequireDefault(_inputfile);

	var _filelist = __webpack_require__(300);
	...
	var App = function (_React$Component) {
	  ...
	  function App(props) {
	    ...
	    _this.loadFileReader = function (e) {
	      PDFJS.getDocument(new Uint8Array(e.target.result)).then(function (pdf) {
	        ...
	        var pageContainer = _this._pageContainer;
	        var pages = _this.state.pages;

	        pages.map(function (page) {
	          return pageContainer.removeChild(page);
	        });
	        pages = [];
	    ...
	    _this.loadFile = function (file) {
	      ...
	      file !== _this.state.currentFile && (_this.setState({ currentFile: file }) || _this.state.fileReader.readAsArrayBuffer(file));
	    };

	    _this.uploadFileHandler = function (e) {
	    ...
	    _this.state.fileReader.onload = _this.loadFileReader.bind(_this);
	    return _this;
	  }
	    ...
	    value: function render() {
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(_filelist2.default, { files: files, loadFile: this.loadFile.bind(this) })
	        ),
	        React.createElement(
	          'div',
	          { className: 'Content' },
	          React.createElement(
	            'h2',
	            { style: { marginTop: 0, color: "#efefef" } },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var InputFile = function (_React$Component) {
	    ...
	    function InputFile() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = InputFile.__proto__ || Object.getPrototypeOf(InputFile)).call.apply(_ref, [this].concat(args))), _this), _this.triggerInput = function (e) {
	            ReactDOM.findDOMNode(_this._inputFile).click();
	    ...
	    _createClass(InputFile, [{
	        ...
	        value: function render() {
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    _button.Button,
	                    { onClick: this.triggerInput, type: "primary" },
	                    React.createElement("input", {
	                        name: "file",
	                        type: "file",
	                        className: "InputFile__input",
	                        ref: function ref(c) {
	                            return _this2._inputFile = c;
	                        },
	                        onChange: this.props.uploadFileHandler
	                    }),
	                    React.createElement(
	                        "label",
	                        { htmlFor: "file", className: "InputFile__label" },
	                        this.props.children
	                    )
	                )
	            );
...
/***/ (function(module, exports) {
	...
	var Button = exports.Button = function Button(_ref) {
	    ...
	    return React.createElement(
	        'button',
	        { onClick: onClick, className: buttonClasses.join(' ') },
	        children
	    );
		};
...
/***/ (function(module, exports) {
	...
	var FileList = function (_React$Component) {
	  ...
	  _createClass(FileList, [{
	    key: '_printSize',
	    value: function _printSize(size) {
	      var sizes = ['Bytes', 'KB', 'MB', 'GB'];
	      var i = 0;while (size > 900) {
	        size /= 1024;i++;
	      }
	    ...
	    value: function render() {
	      ...
	      return React.createElement(
	        ...
	        files.map(function (file) {
	          return React.createElement(
	            'div',
	            { className: 'FileList__item', onClick: function onClick() {
	                return _this2.props.loadFile(file);
	              } },
	            React.createElement(
	              'figure',
	              null,
